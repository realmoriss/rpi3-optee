...
UBOOT_RPI3_FRAGMENT_FILES = $(call qstrip,$(BR2_PACKAGE_UBOOT_RPI3_CONFIG_FRAGMENT_FILES))

UBOOT_RPI3_BUILD_PARAMS = CROSS_COMPILE=$(TARGET_CROSS) ARCH=arm \
	EXT_DTB=$(UBOOT_EXT_DTB) UBOOT_KCONFIG_FRAGMENT_FILES=$(UBOOT_RPI3_FRAGMENT_FILES)
	
UBOOT_RPI3_SIGNED_BUILD_PARAMS = CROSS_COMPILE=$(TARGET_CROSS) ARCH=arm \
	EXT_DTB=$(@D)/signed.dtb UBOOT_KCONFIG_FRAGMENT_FILES=$(UBOOT_RPI3_FRAGMENT_FILES)
